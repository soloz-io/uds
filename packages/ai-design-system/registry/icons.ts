...
export const defaultIcons: Record<string, IconDefinition> = {
  ...
  'smartphone': {
    ...
    viewBox: '0 0 24 24',
    elements: [
      { type: 'rect', attrs: { width: '14', height: '20', x: '5', y: '2', rx: '2', ry: '2' } },
      { type: 'path', attrs: { d: 'M12 18h.01' } },
    ],
  },
  'tablet': {
    name: 'tablet',
  ...
  'camera': {
    ...
    viewBox: '0 0 24 24',
    elements: [
      { type: 'path', attrs: { d: 'M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z' } },
      { type: 'circle', attrs: { cx: '12', cy: '13', r: '3' } },
    ],
  },
  ...
  'gallery-vertical-end': {
    ...
    viewBox: '0 0 24 24',
    elements: [
      { type: 'path', attrs: { d: 'M7 2h10' } },
      { type: 'path', attrs: { d: 'M5 6h14' } },
      { type: 'rect', attrs: { width: '18', height: '12', x: '3', y: '10', rx: '2' } },
    ],
  },
  'credit-card': {
    name: 'credit-card',
  ...
  'history': {
    ...
    viewBox: '0 0 24 24',
    elements: [
      { type: 'path', attrs: { d: 'M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8' } },
      { type: 'path', attrs: { d: 'M3 3v5h5' } },
      { type: 'path', attrs: { d: 'M12 7v5l4 2' } },
    ],
  },
  'dot': {
    name: 'dot',
