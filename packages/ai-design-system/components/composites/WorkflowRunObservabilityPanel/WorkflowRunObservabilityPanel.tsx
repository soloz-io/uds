  ...
  ({
    ...
    return (
      <div className={`flex flex-1 flex-col gap-3 rounded-xl border border-[#2a2a2f] bg-[#050506] p-4 text-[#e6e7eb] ${className ?? ""}`}>
        ...
        <Tabs className="flex min-h-0 flex-1 flex-col" defaultValue="trace">
          <div className="flex items-center justify-between gap-3">
          ...
          <TabsContent className="min-h-0 flex-1" value="trace">
            <div className="grid min-h-0 grid-cols-1 gap-3 lg:grid-cols-[1fr_356px]">
              <div className="min-h-0 rounded-lg border border-[#2a2a2f] bg-[#07080b]">
              ...
              <aside className="space-y-3 rounded-lg border border-[#2a2a2f] bg-[#07080b] p-3">
                <div className="flex items-center justify-between">
                  <h4 className="font-semibold text-sm">Details</h4>
                  <div className="flex items-center gap-2 text-xs">
                    <span className="text-[#8a8c96]">Sleep</span>
                    {selectedSpan?.state ? (
                ...
                {selectedSpan ? (
                  ...
                  <div className="text-[#8a8c96] text-sm">Select a span to inspect details.</div>
                )}
                ...
                <div className="space-y-2 border-t border-[#23242a] pt-3">
                  ...
                  {actions?.length ? (
                    actions.map((action) => (
                      <Button
                        className="h-9 w-full border border-[#4e2f06] bg-[#4a2e06] text-[#f2c98d] hover:bg-[#603b08]"
                ...
                <div className="space-y-2 border-t border-[#23242a] pt-3 text-xs">
                  ...
                  <div className="grid grid-cols-[100px_1fr] gap-y-1">
                    ...
                    <span className="break-all">{run.moduleSpecifier ?? "-"}</span>
          ...
          <TabsContent className="min-h-0 flex-1" value="events">
            <div className="min-h-[320px] space-y-2 overflow-auto rounded-lg border border-[#2a2a2f] bg-[#07080b] p-3">
              {events.length === 0 ? (
          ...
          <TabsContent className="min-h-0 flex-1" value="streams">
            <div className="min-h-[320px] space-y-2 overflow-auto rounded-lg border border-[#2a2a2f] bg-[#07080b] p-3">
              {streams.length === 0 ? (
